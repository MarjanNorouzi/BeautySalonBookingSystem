...
using BeautySalon.InfraStructure.Utilities;
...
namespace BeautySalon.InfraStructure.Repositories
{
    ...
    {
        protected readonly BeautySalonContext DbContext;
        public DbSet<TEntity> Entities { get; }
        public virtual IQueryable<TEntity> Table => Entities;
        public virtual IQueryable<TEntity> TableNoTracking => Entities.AsNoTracking();

        public Repository(BeautySalonContext dbContext)
        {
            DbContext = dbContext;
        ...
        public virtual async Task UpdateCustomPropertiesAsync(TEntity entity, CancellationToken cancellationToken, bool saveNow = true, params string[] properties)
        {
            ...
            if (properties == null || properties.Length == 0)
                throw new Exception("'properties' can't be NULL or Empty");
        ...
        public virtual async Task DeleteByIdAsync(object id, CancellationToken cancellationToken, bool saveNow = true)
        {
            ...
            if (entity == null)
                throw new Exception($"not found {typeof(TEntity).Name} entity to PKey(Id) : '{id}'");
