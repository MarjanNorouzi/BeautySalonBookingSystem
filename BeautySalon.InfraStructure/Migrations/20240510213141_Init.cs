        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UpdatedDate = table.Column<DateTime>(type: "DateTime", nullable: false, defaultValueSql: "CURRENT_TIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Subservice_MainService_MainServiceId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_Operator_OperatorId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SubserviceOperator", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SubserviceOperator_Appointment_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointment",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubserviceOperator_Operator_OperatorId",
                        column: x => x.OperatorId,
                        principalTable: "Operator",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_SubserviceOperator_Subservice_SubserviceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Subservice_MainServiceId",
                table: "Subservice",
                column: "MainServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_SubserviceOperator_AppointmentId",
                table: "SubserviceOperator",
                column: "AppointmentId");

            migrationBuilder.CreateIndex(
                name: "IX_SubserviceOperator_OperatorId",
                table: "SubserviceOperator",
                column: "OperatorId");

            migrationBuilder.CreateIndex(
                name: "IX_SubserviceOperator_SubserviceId",
                table: "SubserviceOperator",
                column: "SubserviceId");
        }
